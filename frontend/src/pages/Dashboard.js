    ...
    return (
        <MainLayout>
            ...
            <div className="mb-8 flex flex-wrap gap-3">
                <Link to="/requests" className="px-5 py-2.5 bg-[#e0bb48] hover:bg-[#d4af3a] transition-colors rounded-xl text-black text-sm font-medium shadow-sm">
                                ...
                                <ul className="space-y-4">
                                    {items.map((task) => (
                                        ...
                                        >
                                            ...
                                            <Link to={task.href} className="text-sm font-medium text-[#cda834] hover:text-[#b8952b] transition-colors flex items-center gap-1">
                                                Перейти
