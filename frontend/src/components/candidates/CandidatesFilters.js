            ...
            <div className="flex flex-wrap gap-4 items-end">
                ...
                <div className="w-full sm:w-48">
                    ...
                    <select
                        ...
                        className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#cda834]/50 focus:border-[#cda834] transition-all appearance-none cursor-pointer"
                ...
                <label className="flex items-center gap-2 cursor-pointer h-[42px] px-4 rounded-xl bg-slate-50 border border-slate-200 hover:bg-slate-100 transition-colors">
                    <input
                        ...
                        className="w-4 h-4 text-[#cda834] bg-white border-slate-300 rounded focus:ring-[#cda834] focus:ring-2 cursor-pointer"
                            ...
                            return (
                                <label
                                    ...
                                    className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-xl border text-sm cursor-pointer transition-colors ${
                                        checked
                                            ? "bg-[#cda834]/15 border-[#cda834] text-slate-900"
                                            : "bg-slate-50 border-slate-200 text-slate-700 hover:bg-slate-100"
                                    }`}
                                >
                                    <input
                                        type="checkbox"
                                        className="w-3.5 h-3.5 text-[#cda834] rounded border-slate-300 focus:ring-[#cda834]"
                                        checked={checked}
